...
.. note:: Replace ``1.11.0`` with the version of the `latest release`_.

.. code-block:: console

 [isabell@stardust ~]$ mkdir ~/screego
 [isabell@stardust ~]$ cd ~/screego
 [isabell@stardust screego]$ wget "https://github.com/screego/server/releases/download/v1.11.0/screego_1.11.0_linux_amd64.tar.gz"
 [isabell@stardust screego]$ tar xvf screego_1.11.0_linux_amd64.tar.gz
 [isabell@stardust screego]$ rm screego_1.11.0_linux_amd64.tar.gz
...
Tested with Screego 1.11.0, Uberspace 7.16.1
