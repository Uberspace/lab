...
.. code-block:: console
  ...
  [isabell@stardust ~]$ VERSION=1.8.0
...
| Override the ``config.json`` file that was generated by the setup and adapt the credentials. It is a copy of ``config.json.example`` if you like to have a look at it.
...
Tested with HedgeDoc 1.8.0, Uberspace 7.11.0.0
