...
It's a `hard-fork <https://forgejo.org/2024-02-forking-forward/>`_ of Gitea_ since 02.2024 and uses the same MIT licence_. As most applications written in Go it's easy to install.
